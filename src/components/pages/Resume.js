        ...
        <Col>
          ...
          >
            ...
            <div className="">
              ...
              Competitive Programmer. I have a good understanding of Data
                  ...
                  {resumeSkills.map((skill, index) => {
                    return (
                      <li key={index} className="">
                        <strong className={darkMode ? "color-primary" : ""}>
                          {" "}
                          {skill.skillType}:{" "}
                        </strong>
                        {skill.skills}
                ...
                return (
                  <div key={index}>
                    ...
                    >
                      ...
                      <div className="text-start">{project.year}</div>
                    </div>
                    <div className="text-start m-0">{project.technology}</div>
                    {project.features ? (
                      <ul>
                        {project.features.map((feature, index1) => {
                          return <li key={index1}>{feature}</li>;
                        })}
                      </ul>
                    ) : null}
                  </div>
                ...
                {resumeEducation.map((education, index) => {
                  return (
                    <div key={index}>
                      ...
                      <div className="m-0 p-0">{education.degree}</div>
                      <div className="m-0 p-0">{education.duration}</div>
                ...
                {resumeExperience.map((experience, index) => {
                  return (
                    <div key={index}>
                      ...
                      <ul>
                        {experience.list.map((item, index1) => {
                          return (
                            <li key={index1} className="m-0 p-0">
                              {item}
                            </li>
                          );
                        })}
