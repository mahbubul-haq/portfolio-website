            ...
            <div className="container-fluid p-0">
              {
                ...
                <div className="col-12 h4 fw-semibold">{skill.skillType}</div>
                ...
                {progress ? (
                  <>
                    ...
                    <div
                      className="col-12 col-sm-6 d-flex align-items-center m-0 mt-1"
                    ...
                    >
                      ...
                      >
                        <div
                          ...
                          aria-valuemax={100}
                          style={{ width: `${current.progress}%`, color: "black", textAlign: "right" }}
                        >
                          {current.progress}%
                        </div>
                      </div>
                  ...
                  <div key={index1} className="col-auto me-2">
                    {current.name}{index1 !== skill.list.length - 1 ? "," : ""}
                  </div>
                )}
                </>
                  );
